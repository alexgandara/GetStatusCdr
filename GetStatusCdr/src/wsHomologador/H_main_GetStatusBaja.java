...
public class H_main_GetStatusBaja {
	...
	public static String _numeroComprobante="";
	...
	//	System.setOut(console);
		...
		int _tam = _serie_original.length();
		...
		_rucComprobante =_serie_original.substring(1, 11);
		_tipoComprobante="Baja";
		_serieComprobante=_serie_original.substring(16, 19);
		_numeroComprobante=_serie_original.substring(22, _tam);
		...
		$FILE_CDR_PDF=$PATH_CDR_PDF+"cdr_baja_"+_serie_original+".pdf";
		
		
		$FILE_NAME_ZIP=$FILE_NAME+".zip";
		$FILE_PATH_NAME_RESPUESTA_CDR=$PATH_RESPUESTAS+"R-"+$FILE_NAME+".zip";
		$FILE_PATH_NAME_RESPUESTA_XML=$PATH_RESPUESTAS+"R-"+$FILE_NAME+".xml";
		$FILE_JPG=$PATH_FORMATOS+"reporteCDR.jpg";
		
		System.out.println($FILE_PATH_NAME_RESPUESTA_XML);
		System.out.println($PATH_RESPUESTAS);
		UnZip.descomprimir($FILE_PATH_NAME_RESPUESTA_CDR,$PATH_RESPUESTAS);
		$FILE_ZIP_SOURCE=$PATH_RESPUESTAS+"R-"+file_name+".zip";
		$FILE_XML_RESPUESTA = $FILE_PATH_NAME_RESPUESTA_CDR;
		$FILE_TXT = $PATH_RESPUESTAS+file_name+".txt";
...
//					public String _SignatureValue;
			...
			//	System.out.println("Signature Value _ _ _ _ _ _ _ _: " + _temp01);
				...
				if (_temp01.length()>40) {
					...
					miRespuesta.set_value00("");
					miRespuesta.set_value01("");
					miRespuesta.set_value02("");
					miRespuesta.set_value03("");
					miRespuesta.set_value04("");
					miRespuesta.set_value05("");
					miRespuesta.set_value06("");
					miRespuesta.set_value07("");
					miRespuesta.set_value08("");
...
//					public String _ReceiverParty;
				...
				System.out.println("Ruc Receptor_ _ _ _ _ _ _ _ _ : " + miRespuesta.get_ReceiverParty());
				...
				System.out.println("Notas _ _ _ _ _ _ _ _ _ : " + miRespuesta.get_Note());
