...
public class printPDFA4Resumen {
	...
	public static void imp_factura(String _file_xml,  String _file_pdf, String _file_jpg, respuesta miRespuesta, String _serie_original) throws DocumentException, IOException {
	...
	//	System.out.println("Pdf:"+_file_pdf);
	   ...
	   //     System.out.println("jpg:"+formato_factura );
	    ...
	    //    	canvas.showText(":  "+_serie_original);	        // (Hello World)Tj
	        ...
	        canvas.saveState();                               // q
	        canvas.beginText();                               // BT
	        canvas.moveText(20, 130+375);                         // 36 788 Td
	        canvas.setFontAndSize(bf_cal, 8); // /F1 12 Tf
	        ...
	        String _desc04=textoFormateado.substring(240, 300);
	        	...
	        	canvas.saveState();                               // q
	        	canvas.beginText();                               // BT
	        	canvas.moveText(250, 130+375);                         // 36 788 Td
	        	...
	        	canvas.saveState();                               // q
		        canvas.beginText();                               // BT
		        canvas.moveText(250, 120+375);                         // 36 788 Td
		        canvas.setFontAndSize(bf, 9); // /F1 12 Tf
