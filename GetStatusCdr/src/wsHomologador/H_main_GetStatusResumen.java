...
public class H_main_GetStatusResumen {
	...
	public static void conectar(StatusResponse StatusResponse, String file_name, parametros misParametros, String _serie_original ) throws Exception {
		...
		$FILE_CDR_PDF=$PATH_CDR_PDF+"cdr_resumen_"+_serie_original+".pdf";
...
//					public String _ReceiverParty;
				...
				System.out.println("Notas_ _ _ _ _ _ _ _ _ _ _ _ _ _ _: " + miRespuesta.get_Note());
				...
				printPDFA4Resumen.imp_factura($FILE_PATH_NAME_RESPUESTA_XML, $FILE_CDR_PDF, $FILE_JPG, miRespuesta, _serie_original);
